...
public:
  ...
  void handleOutput(ArNetPacket *packet);			/// This callback is called when an update on general robot state arrives
  void handleRangeData(ArNetPacket *packet);		/// This callback is called when an update on the temperature information changes
  void handleRangeData2(ArNetPacket *packet);		/// This callback is called when an update on the temperature information changes
  ...
  void handleOutputNumbers(ArNetPacket *packet);	/// This callback is called when an update on general robot state arrives
  void handleOutputStrings(ArNetPacket *packet);	/// This callback is called when an update on general robot state arrives
  ...
  KDL::Tree myKdlTree;					//used for visualization
...
protected:
  ...
  ArFunctor1C<AriaClientDriver, ArNetPacket *> myHandleOutputCB;
  ArFunctor1C<AriaClientDriver, ArNetPacket *> myHandleOutputNumbersCB;
  ArFunctor1C<AriaClientDriver, ArNetPacket *> myHandleOutputStringsCB;
  ...
  ArFunctor1C<AriaClientDriver, ArNetPacket *> myHandleRangeDataCB2;
